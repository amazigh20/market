...
$resultat = $con->query("SELECT * FROM produits,categories where categories.ID_cat = produits.ID_cat ORDER BY produits.ID_cat,date_publication DESC");
?>
...
<hr color='white'>
	...
	<table width='80%' border=0>
		...
		<tr id='menu' bgcolor='#232f3e'>
			<td><b>
					<font color="white">Catégories</font>
				</b></td>
			<td><b>

...
<body>
	<nav>
		<ul>
			...
			<li> 
				<a class="menu" href="accueil.php"><img class="menu" src="./img/accueil.png" alt="">Accueil</a> </li>
			<li> 
				<a class="menu" href="GestionProduits.php"><img class="menu" src="./img/produits.png" alt="produits">Produits</a> </li>
...
?>
		<div class="Div_Panier">
			<a class="cart" href="panier.php"><img class="cart" src="./img/cart1.png" /> <?php echo $panier_count; ?></a>
		</div>
		<?php
}

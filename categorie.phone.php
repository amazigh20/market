...
$resultat = $con->query("SELECT * FROM produits,categories where categories.ID_cat = produits.ID_cat and produits.ID_cat=2 ORDER BY produits.ID_cat,date_publication DESC");
?>

...
$resultat = $con->query("SELECT * FROM produits,categories where categories.ID_cat = produits.ID_cat and produits.ID_cat=1 ORDER BY produits.ID_cat,date_publication DESC");
?>
...
<body>
	...
	<nav class="cat">
		<ul class="cat">
        <li class="cat"><a class="cat" name="info" href="GestionProduits.php"><img class="cat" src="./img/all.png" alt="categories">afficher tout</a></li>
			...
			<li class="cat"><a class="cat" name="loisirs" href="categorie.loisirs.php"><img class="cat" src="./img/loisirs.png" alt="Loisirs">Sport & Loisirs</a></li>
